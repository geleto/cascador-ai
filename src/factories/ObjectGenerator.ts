...
): GenerateObjectReturn<TConfig, 'text', OUTPUT, ENUM, PROMPT> & results.RendererTool<INPUT, OUTPUT>;
...
>(
	...
	OUTPUT, ENUM, PARENT_OUTPUT, PARENT_ENUM, PROMPT> & results.RendererTool<FINAL_INPUT, FINAL_OUTPUT>;
